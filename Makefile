...
REGISTRY ?= quay.io
REPOSITORY ?= $(REGISTRY)/redhat-cop/podpreset-webhook
DEV_TAG ?= dev
...
LDFLAGS := "-X github.com/redhat-cop/podpreset-webhook/version.Version=$(VERSION) \
	-X github.com/redhat-cop/podpreset-webhook/version.Vcs=$(BUILD_COMMIT) \
	-X github.com/redhat-cop/podpreset-webhook/version.Timestamp=$(BUILD_TIMESTAMP) \
	-X github.com/redhat-cop/podpreset-webhook/version.Hostname=$(BUILD_HOSTNAME)"
...
manager: generate fmt vet
	go build -o build/_output/bin/podpreset-webhook  -ldflags $(LDFLAGS) github.com/redhat-cop/podpreset-webhook/cmd/manager

# Build manager binary
manager-osx: generate fmt vet
	go build -o build/_output/bin/podpreset-webhook GOOS=darwin  -ldflags $(LDFLAGS) github.com/redhat-cop/podpreset-webhook/cmd/manager
